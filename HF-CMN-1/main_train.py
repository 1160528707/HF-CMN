...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='D:\\xinshuai\\mimic\\P_0\\CXR\\',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='D:\\xinshuai\\mimic\\P_0\\HF_trainval.json',
                        help='the path to the directory containing the data.')

    parser.add_argument('--init_protypes_path_111', type=str, default='D:\\xinshuai\\mimic\\P_0\\init_prototypes.pt',
                        help='the path to the directory containing the data.')
    # parser.add_argument('--init_protypes_path_110', type=str, default='D:\\Xinshuai\\mimic\\fea.pt',
    #                     help='the path to the directory containing the data.')
    # parser.add_argument('--init_protypes_path_101', type=str, default='D:\\Xinshuai\\mimic\\fea.pt',
    #                     help='the path to the directory containing the data.')
    # parser.add_argument('--init_protypes_path_100', type=str, default='D:\\Xinshuai\\mimic\\fea.pt',
    #                     help='the path to the directory containing the data.')
    #
    #
    # parser.add_argument('--label_path', type=str, default='D:\\Xinshuai\\mimic\\labels_3_pickle\\labels_3.pickle',
    #                     help='the path to the directory containing the data.')
    ...
    parser.add_argument('--save_dir', type=str, default='D:\\xinshuai\\论文\\第一部分\\代码\\model\\P_0\\', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='D:\\xinshuai\\论文\\第一部分\\代码\\model\\P_0\\', help='the patch to save the results of experiments.')
    ...
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.') #保存网络训练记录地址
