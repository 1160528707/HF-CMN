...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='D:\\xinshuai\\mimic\\C_1\\CXR\\',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='D:\\xinshuai\\mimic\\C_1\\HF_trainval.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--init_protypes_path_111', type=str, default='D:\\xinshuai\\mimic\\C_1\\init_prototypes.pt',
                        help='the path to the directory containing the data.')
